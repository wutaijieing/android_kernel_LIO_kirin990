...
int dc_batinfo_ops_register(unsigned int type, struct direct_charge_batinfo_ops *ops);
...
int dc_batinfo_init(int type);
int dc_batinfo_exit(int type);
int dc_get_bat_btb_voltage(int type);
int dc_get_bat_package_voltage(int type);
int dc_get_bat_btb_voltage_with_comp(int type, const int *vbat_comp);
int dc_get_vbus_voltage(int type, int *vbus);
int dc_get_bat_current(int type, int *ibat);
int dc_get_bat_current_with_comp(int type, int *ibat);
int dc_get_ic_ibus(int type, int *ibus);
int dc_get_ic_temp(int type, int *temp);
int dc_get_ic_vusb(int type, int *vusb);
int dc_get_ic_vout(int type, int *vout);
int dc_get_ic_max_temp(int *temp);
int dc_get_total_ibus(int *ibus);
int dc_get_total_bat_current(int *ibat);
int dc_get_bat_btb_avg_voltage(int *vbat);
int dc_get_bat_package_avg_voltage(int *vbat);
int dc_get_vbus_avg_voltage(int *vbus);
#else
...
static inline int dc_batinfo_ops_register(unsigned int type, struct direct_charge_batinfo_ops *ops)
{
	return -1;
}
...
static inline int dc_batinfo_init(int type)
{
	return -1;
}

static inline int dc_batinfo_exit(int type)
{
	return -1;
}

static inline int dc_get_bat_btb_voltage(int type)
{
	return -1;
}

static inline int dc_get_bat_package_voltage(int type)
{
	return -1;
}

static inline int dc_get_bat_btb_voltage_with_comp(int type, const int *vbat_comp)
{
	return -1;
}

static inline int dc_get_vbus_voltage(int type, int *vbus)
{
	return -1;
}

static inline int dc_get_bat_current(int type, int *ibat)
{
	return -1;
}

static inline int dc_get_bat_current_with_comp(int type, int *ibat)
{
	return -1;
}

static inline int dc_get_ic_ibus(int type, int *ibus)
{
	return -1;
}

static inline int dc_get_ic_temp(int type, int *temp)
{
	return -1;
}

static inline int dc_get_ic_vusb(int type, int *vusb)
{
	return -1;
}

static inline int dc_get_ic_vout(int type, int *vout)
{
	return -1;
}

static inline int dc_get_ic_max_temp(int *temp)
{
	return -1;
}

static inline int dc_get_total_ibus(int *ibus)
{
	return -1;
}

static inline int dc_get_total_bat_current(int *ibat)
{
	return -1;
}

static inline int dc_get_bat_btb_avg_voltage(int *vbat)
{
	return -1;
}

static inline int dc_get_bat_package_avg_voltage(int *vbat)
{
	return -1;
}

static inline int dc_get_vbus_avg_voltage(int *vbus)
{
	return -1;
}
