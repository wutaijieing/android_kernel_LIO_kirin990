...
static void asp_reg_init(struct snd_soc_codec *codec)
{
...
static int asp_regulator_enable(struct snd_soc_codec *codec)
{
	int ret;
	struct asp_codec_priv *priv = snd_soc_codec_get_drvdata(codec);
...
static void asp_regulator_disable(struct snd_soc_codec *codec)
{
	struct asp_codec_priv *priv = snd_soc_codec_get_drvdata(codec);
...
static int asp_clk_enable(struct snd_soc_codec *codec)
{
	int ret;
	struct asp_codec_priv *priv = snd_soc_codec_get_drvdata(codec);
...
static void asp_clk_disable(struct snd_soc_codec *codec)
{
	struct asp_codec_priv *priv = snd_soc_codec_get_drvdata(codec);
...
static int asp_resource_enable(struct snd_soc_codec *codec)
{
	int ret;
...
static void asp_resource_disable(struct snd_soc_codec *codec)
{
	asp_clk_disable(codec);
	asp_regulator_disable(codec);
}

static int codec_pinctrl_init(struct snd_soc_codec *codec)
{
	int ret;
...
static void codec_pinctrl_deinit(struct snd_soc_codec *codec)
{
	struct asp_codec_priv *priv = snd_soc_codec_get_drvdata(codec);
...
static void codec_pm_runtime_init(struct snd_soc_codec *codec)
{
	struct device_node *np = codec->dev->of_node;
	struct asp_codec_priv *priv = snd_soc_codec_get_drvdata(codec);
...
static void codec_pm_runtime_deinit(struct snd_soc_codec *codec)
{
	struct asp_codec_priv *priv = snd_soc_codec_get_drvdata(codec);
...
static int codec_resource_init(struct snd_soc_codec *codec)
{
	int ret = 0;
	struct asp_codec_priv *priv = snd_soc_codec_get_drvdata(codec);
...
static void codec_resource_deinit(struct snd_soc_codec *codec)
{
	struct asp_codec_priv *priv = snd_soc_codec_get_drvdata(codec);
...
/*lint -e429*/
static int codec_priv_init(struct snd_soc_codec *codec)
{
...
static void codec_priv_deinit(struct snd_soc_codec *codec)
{
	struct asp_codec_priv *priv = snd_soc_codec_get_drvdata(codec);
...
static int init_component_driver(struct snd_soc_codec *codec,
	struct snd_soc_dapm_context *dapm)
{
	int ret;

	ret = asp_codec_add_kcontrols(codec);
	if (ret) {
...
static int asp_codec_codec_probe(struct snd_soc_codec *codec)
{
...
static int asp_codec_codec_remove(struct snd_soc_codec *codec)
{
	IN_FUNCTION;
...
static int asp_codec_probe(struct platform_device *pdev)
{
	...
	dev_set_name(&pdev->dev, "asp-codec-990");
...
{
	int ret;
	struct asp_codec_priv *priv = snd_soc_codec_get_drvdata(soc_codec);
...
struct snd_soc_codec *asp_codec_get_codec(void)
{
	return soc_codec;
}
...
static const struct of_device_id asp_codec_match[] = {
	{ .compatible = "hisilicon,asp-codec-990", },
	{},
};
