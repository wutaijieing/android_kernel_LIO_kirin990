...
static unsigned int hisi_pcm_get_hw_buffer_bytes_max(void)
{
	int device, stream;
	unsigned int ret = 0;
...
static int _allocate_ec_buff(struct device *dev)
{
	unsigned int max = hisi_pcm_get_hw_buffer_bytes_max();
