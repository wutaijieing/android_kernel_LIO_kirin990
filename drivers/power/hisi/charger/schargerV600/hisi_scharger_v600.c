...
#endif
#ifdef CONFIG_WIRED_CHANNEL_SWITCH
		ret[4] = wired_chsw_ops_register(&hi6526_chsw_ops);
#endif

		for (i = 0; i < RET_SIZE_5; i++) {
			if (ret[i])
