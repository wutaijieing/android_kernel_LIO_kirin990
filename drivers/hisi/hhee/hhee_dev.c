...
static int __init hisi_hhee_device_init(void)
{
	int ret;
...
static void __exit hisi_hhee_device_exit(void)
{
...
/*lint -e528 -esym(528,*)*/
/*lint -e753 -esym(753,*)*/
module_init(hisi_hhee_device_init);
module_exit(hisi_hhee_device_exit);

MODULE_DESCRIPTION("hisi hhee driver");
MODULE_ALIAS("hisi hhee module");
MODULE_LICENSE("GPL");
/*lint -e528 +esym(528,*)*/
/*lint -e753 +esym(753,*)*/
