...
#endif
#ifdef CONFIG_HISEE_SUPPORT_AUTH_UPGRADE
	CMD_SET_UPGRADE_FLAG_ADDR = 0x71,
	CMD_SET_AUTHSWITCH = 0x72,
	CMD_CLR_UPDATEFLAG = 0x73,
#endif
	CMD_END,
};
...
#endif
#ifdef CONFIG_HISEE_SUPPORT_AUTH_UPGRADE
	volatile u32 *upgrade_vir_addr;
	dma_addr_t upgrade_phy_addr;
#endif
};
...
int send_smc_process(struct atf_message_header *p_message_header,
