...
enum {
	COS_FLASH_EMPTY = 0,  /* encos partition is empty */
	COS_FLASH_EXIST,  /* exist cosflash, can run */
	COS_FLASH_ERASE,  /* cosflash has been erased by kernel */
};

#define COS_FLASH_ERASE_FLAG_OFFSET 1
#define COS_FLASH_ERASE_FLAG_MAGIC  "ERASE"
#endif
