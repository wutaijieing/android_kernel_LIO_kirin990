...
VOS_UINT32 VRRC_SetGnssInfo(MN_CLIENT_ID_T clientId, MN_OPERATION_ID_T opId)
{
    ...
    /* 申请消息 */
    msg = (AT_VRRC_ReqMsg *)PS_ALLOC_MSG(WUEPS_PID_AT, sizeof(AT_VRRC_ReqMsg) - VOS_MSG_HEAD_LENGTH);
    if (msg == VOS_NULL_PTR) {
...
VOS_UINT32 VMAC_QryVRssi(MN_CLIENT_ID_T clientId, MN_OPERATION_ID_T opId)
{
    ...
    /* 申请消息 */
    msg = (AT_VMAC_ReqMsg *)PS_ALLOC_MSG(WUEPS_PID_AT, sizeof(AT_VMAC_ReqMsg) - VOS_MSG_HEAD_LENGTH);
    if (msg == VOS_NULL_PTR) {
...
VOS_UINT32 VPDCP_QryPtrRpt(MN_CLIENT_ID_T clientId, MN_OPERATION_ID_T opId)
{
    ...
    /* 申请消息 */
    msg = (AT_VPDCP_ReqMsg *)PS_ALLOC_MSG(WUEPS_PID_AT, sizeof(AT_VPDCP_ReqMsg) - VOS_MSG_HEAD_LENGTH);
    if (msg == VOS_NULL_PTR) {
...
VOS_UINT32 VPDCP_SetPtrRpt(MN_CLIENT_ID_T clientId, MN_OPERATION_ID_T opId)
{
    ...
    msg    = (AT_VPDCP_ReqMsg *)PS_ALLOC_MSG(WUEPS_PID_AT, length);
    if (msg == VOS_NULL_PTR) {
        return VOS_ERR;
    }
...
VOS_UINT32 VMAC_SetMcgCfgPara(MN_CLIENT_ID_T clientId, MN_OPERATION_ID_T opId, const AT_VMAC_McgCfgSet *setParams)
{
    ...
    msg    = (AT_VMAC_ReqMsg *)PS_ALLOC_MSG(WUEPS_PID_AT, length);
    if (msg == VOS_NULL_PTR) {
        return VOS_ERR;
    }
...
VOS_UINT32 VRRC_SYNC_SetCfgPara(MN_CLIENT_ID_T clientId, MN_OPERATION_ID_T opId, constAT_VRRC_Pc5syncSet *setParams)
{
    VOS_UINT32          rslt;
    VOS_UINT32          length;
    AT_VRRC_ReqMsg     *msg    = VOS_NULL_PTR;
