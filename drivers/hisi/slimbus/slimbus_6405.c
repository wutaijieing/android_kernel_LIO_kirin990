...
static uint8_t cn_table_audio_up[SLIMBUS_PORT_VERSION_MAX][SLIMBUS_CHANNELS_MAX] = {
	...
	{AUDIO_CAPTURE_CHANNEL_LEFT, AUDIO_CAPTURE_CHANNEL_RIGHT, DEBUG_LEFT, DEBUG_RIGHT},
};
...
static uint8_t source_pn_table_audio_up[SLIMBUS_PORT_VERSION_MAX][SLIMBUS_CHANNELS_MAX] = {
	...
	{AUDIO_CAPTURE_64XX_LEFT_PORT, AUDIO_CAPTURE_64XX_RIGHT_PORT, BT_CAPTURE_64XX_LEFT_PORT, BT_CAPTURE_64XX_RIGHT_PORT},
};
...
static uint8_t sink_pn_table_audio_up[SLIMBUS_PORT_VERSION_MAX][SLIMBUS_CHANNELS_MAX] = {
	...
	{AUDIO_CAPTURE_SOC_LEFT_PORT, AUDIO_CAPTURE_SOC_RIGHT_PORT, BT_CAPTURE_SOC_LEFT_PORT, BT_CAPTURE_SOC_RIGHT_PORT},
};
