...
#define HIFI_ICC_DEBUG_SIZE                 (0x11000)
#define HIFI_SOCP_BUFFER_SIZE               (0x2000)
...
#define HISI_DP_AUDIO_DATA_BUFF_SIZE        (0x0)
#endif
#define HISI_AP_AUDIO_PA_BUFF_SIZE          (0x4000)
#define HISI_AP_AUDIO_WAKEUP_RINGBUFEER_SIZE   (0x1E000)
#define HISI_AP_AUDIO_WAKEUP_CAPTURE_SIZE   (0x2000)
...
#define HIFI_SOCP_BUFFER_ADDR           (HIFI_ICC_DEBUG_LOCATION + HIFI_ICC_DEBUG_SIZE)
#define HIFI_FLAG_DATA_ADDR             (HIFI_SOCP_BUFFER_ADDR + HIFI_SOCP_BUFFER_SIZE)
...
#define DRV_DSP_SCREEN_STATUS           (DRV_DSP_PCM_THREAD_DATA_ADDR + HIFI_PCM_THREAD_DATA_SIZE)
...
#elif defined(CONFIG_ORLANDO_2MIC_LP_WAKEUP)
#define HIFI_RUN_SIZE                   (0xD00000)
#else
...
typedef enum HIFI_MSG_ID_ {
	...
	ID_HIFI_AP_HOOK_DATA_CMD            = 0xDDD1, /* hifi send pcm data to ap for om */
	...
	ID_HIFI_AP_SMARTPA_DFT              = 0xDF11,
	ID_HIFI_AP_AUDIO_DB                 = 0xDF12,
	ID_AP_AUDIO_CMD_SET_COMBINE_RECORD_FUNC_CMD  = 0xDF22,/* hal notify HIFI combine record cmd */
	ID_AP_HIFI_MADTEST_START            = 0xDF23, /* MMI MAD TEST START CMD */
	ID_AP_HIFI_MADTEST_STOP             = 0xDF24, /* MMI MAD TEST STOP CMD */
	ID_AP_HIFI_VIBRATOR_CMD             = 0xDF25, /* VIBRATOR MSG */
