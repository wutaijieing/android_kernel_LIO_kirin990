...
#define RUNTIME_GPU_PCR_ADDR (RUNTIME_VAR_BASE + 0x52)
#define GPU_PCR (BYTE_REF(RUNTIME_GPU_PCR_ADDR))
#define RUNTIME_GPU_VAR_END (RUNTIME_GPU_PCR_ADDR)
...
#define RUNTIME_LIGHT_SLEEP_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x018)
#define LIGHT_SLEEP_CNT (WORD_REF(RUNTIME_LIGHT_SLEEP_CNT_ADDR))
#define RUNTIME_LIGHT_SLEEP_RESUME_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x01C)
...
#define RUNTIME_HISEE_WAKE_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x034)
...
#define RUNTIME_HISEE_SUSPEND_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x058)
#define HISEE_SUSPEND_CNT (WORD_REF(RUNTIME_HISEE_SUSPEND_CNT_ADDR))
#define RUNTIME_HISEE_RESUME_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x05C)
...
#define RUNTIME_ARMPC_SR_PARAMETER_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0xB8)
#define ARMPC_SR_PARAMETER (WORD_REF(RUNTIME_ARMPC_SR_PARAMETER_ADDR))
#define RUNTIME_CLENT_VOTE_TIME_ADDR(n) (RUNTIME_SR_VAR_BASE_ADDR + 0xBC + (n) * 4)
#define CLENT_VOTE_TIME(n) (WORD_REF(RUNTIME_CLENT_VOTE_TIME_ADDR(n)))
#define RUNTIME_SPACE_ADDR_END (RUNTIME_CLENT_VOTE_TIME_ADDR(9))
