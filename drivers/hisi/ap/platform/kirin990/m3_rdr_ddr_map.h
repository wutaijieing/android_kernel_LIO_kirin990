...
#define M3_RDR_DDR_VOTE_TIME_OFFSET (M3_RDR_AOTCP_OFFSET + M3_RDR_AOTCP_SIZE)
...
#define M3_RDR_SYS_CONTEXT_RESERVED_ADDR (M3_RDR_DDR_VOTE_TIME_ADDR + M3_RDR_DDR_VOTE_TIME_SIZE)
