...
static int sy6510_device_check(void)
{
	int ret;
	struct sy6510_dev_info *di = g_sy6510_di;
...
static int sy6510_chip_init(void)
{
	int ret = 0;
...
static bool sy6510_is_bp_open(void)
{
	int ret;
	u8 status = 0;
...
static int sy6510_post_probe(void)
{
	struct sy6510_dev_info *di = g_sy6510_di;
...
static int sy6510_reverse_chip_init(void)
{
