...
static int pca9488_set_reverse_bp2cp_mode(void)
{
	int ret;
...
static int pca9488_set_reverse_cp_mode(void)
{
	int ret;
...
static int pca9488_reverse_cp_chip_init(void)
{
	int ret;

	ret = pca9488_set_reverse_cp_mode();
	ret += pca9488_reverse_chip_init();
