	...
	char *buf, size_t size)
{
	...
	(void)dc_get_ic_ibus(CHARGE_IC_MAIN, &ibus);
	return scnprintf(buf, size, "%d\n", ibus);
}
	...
	char *buf, size_t size)
{
	...
	(void)dc_get_ic_ibus(CHARGE_IC_AUX, &ibus);
	return scnprintf(buf, size, "%d\n", ibus);
}
	...
	char *buf, size_t size)
{
	...
	(void)dc_get_vbus_voltage(CHARGE_IC_MAIN, &vbus);
	return scnprintf(buf, size, "%d\n", vbus);
}
	...
	char *buf, size_t size)
{
	...
	(void)dc_get_vbus_voltage(CHARGE_IC_AUX, &vbus);
	return scnprintf(buf, size, "%d\n", vbus);
}
	...
	char *buf, size_t size)
{
	...
	(void)dc_get_ic_vout(CHARGE_IC_MAIN, &vout);
	return scnprintf(buf, size, "%d\n", vout);
}
	...
	char *buf, size_t size)
{
	...
	(void)dc_get_ic_vout(CHARGE_IC_AUX, &vout);
	return scnprintf(buf, size, "%d\n", vout);
}
	...
	char *buf, size_t size)
{
	...
	(void)dc_get_bat_current(CHARGE_IC_AUX, &ibat);
	return scnprintf(buf, size, "%d\n", ibat);
}
...
static ssize_t direct_charge_dbg_main_vbat_show(void *dev_data,
	char *buf, size_t size)
{
	int vbat = dc_get_bat_btb_voltage(CHARGE_IC_MAIN);
...
static ssize_t direct_charge_dbg_aux_vbat_show(void *dev_data,
	char *buf, size_t size)
{
	int vbat = dc_get_bat_btb_voltage(CHARGE_IC_AUX);
	...
	char *buf, size_t size)
{
	...
	(void)dc_get_ic_temp(CHARGE_IC_MAIN, &ic_temp);
	return scnprintf(buf, size, "%d\n", ic_temp);
}
	...
	char *buf, size_t size)
{
	...
	(void)dc_get_ic_temp(CHARGE_IC_AUX, &ic_temp);
	return scnprintf(buf, size, "%d\n", ic_temp);
}
