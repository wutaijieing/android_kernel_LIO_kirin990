    ...
    uint8_t *puc_curr_bssid)
{
    ...
    if (oal_any_null_ptr2(pst_hmac_sta, puc_req_frame)) {
        oam_error_log0(0, OAM_SF_ASSOC, "{hmac_mgmt_encap_asoc_req_sta::para null.}");
    ...
    if (oal_any_null_ptr2(pst_mac_device, pst_scaned_bss)) {
        oam_error_log0(pst_mac_vap->uc_vap_id, OAM_SF_ASSOC, "{hmac_mgmt_encap_asoc_req_sta::PTR NULL.}");
        return us_asoc_rsq_len;
    }
